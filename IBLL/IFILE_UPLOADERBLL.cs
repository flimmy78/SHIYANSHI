...
namespace Langben.IBLL
{
    ...
    public partial interface IFILE_UPLOADERBLL
    {
        ...
        /// <returns>结果集</returns>
        [OperationContract]
        List<FILE_UPLOADER> GetByParam(string id, int page, int rows, string order, string sort, string search, ref int total);
        /// <summary>
        /// 查询的数据
        /// </summary>
        /// <param name="id">额外的参数</param>
        ...
        /// <returns>结果集</returns>
        [OperationContract]
        List<FILE_UPLOADER> GetByParam(string id, string order, string sort, string search); /*在6.0版本中 新增*/
        /// <summary>
        /// 获取所有
        /// </summary>
        /// <returns></returns>
        ...
        /// <returns></returns>
        [OperationContract]
         bool Create(ref Common.ValidationErrors validationErrors, FILE_UPLOADER entity); 
        /// <summary>
        /// 删除一个对象
        /// </summary>
        /// <param name="validationErrors">返回的错误信息</param>
