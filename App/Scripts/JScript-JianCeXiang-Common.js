...
RuleAttributeArray = [
    ...
    ,
    {
        RuleID: 'JJG440-2008_3_2',//检测项编号
        Remark: '工频单相相位输出（测量）-绝对误差-两列',//检测项说明
        Attributes:
        [{
            //添加通道按钮是否显示(show:显示，hidden:不显示)
            DuoTongDao: 'hidden',
    ...
    ,
    {
        RuleID: 'JJG440-2008_3_3',//检测项编号
        Remark: '工频单相相位输出（测量）-绝对误差-三列 (多通道）',//检测项说明
        Attributes:
        [{
            //添加通道按钮是否显示(show:显示，hidden:不显示)
            DuoTongDao: 'hidden',
