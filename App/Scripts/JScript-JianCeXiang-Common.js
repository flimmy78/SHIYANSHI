...
DanWeiDDLHtmlArray = [
            {
                Code: 'EDingDianLiu',
                Remark: '额定电流(A)',
                Value: "<select class=\"my-combobox\" name=\"shuzi521\" style=\"width:50px; \">" +
...
RuleAttributeArray = [
    {//
        ...
        RuleID: '982-2003_6_2',//检测项编号
        Remark: '示值误差-有电压示值-末盘值残余电阻参与运算',//检测项说明
        Attributes:
        [{
            //添加通道按钮是否显示show:显示，hidden:不显示
            DuoTongDao: 'show',
    ...
    },
    {
        ...
        Attributes:
            [{
                ...
                //检测项单位联动下拉框联动:变更项名称1|联动相名称1,联动相名称2;变更项名称2|联动相名称1,联动相名称2
                //一个量程下的单位与对应的输出示值和输出实际值的单位联动，更改量程的单位输出示值和输出实际值单位自动变更
                LianDongDanWeiDDL: 'RANGE|READVALUE,SHIJISHUCHUZHI,RELATIVEERROR,UNCERTAINTYDEGREE;',//         LianDongDanWeiDDL: 'RANGE|READVALUE,SHIJISHUCHUZHI,UNCERTAINTYDEGREE;',
                //检测项属性单位下拉框选项单位类型1|检测项属性单位名称1,检测项属性单位名称2;单位类型2|检测项属性单位名称1,检测项属性单位名称2
                //DianLiu:电流单位；DianYa:电压单位   
                //DianLiu|RANGE_UNIT:量程,OUTPUT_VALUE_UNIT:输出示值,ACTUAL_OUTPUT_VALUE_UNIT：输出实际值;DianYa|READ_VALUE_UNIT:读数值',
    ...
    },
    {
        ...
        Attributes:
            [{
                ...
                //DianLiu:电流单位；DianYa:电压单位   
                //DianLiu|RANGE_UNIT:量程,OUTPUT_VALUE_UNIT:输出示值,ACTUAL_OUTPUT_VALUE_UNIT：输出实际值;DianYa|READ_VALUE_UNIT:读数值',
                DanWeiHtmlDDL: 'DianLiu|RANGE,READVALUE,SHIJISHUCHUZHI,RELATIVEERROR,UNCERTAINTYDEGREE;',
                //READ_VALUE:读数值,ACTUAL_OUTPUT_VALUE:输出实际值,RELATIVE_ERROR:相对误差,UNCERTAINTY_DEGREE:不确定度,REMARK:注,CONCLUSION:结论
                BuBaoCunShuJu: '',
                //添加量程自动计算赋值列,检测项属性单位名称1,检测项属性单位名称2,
                //OUTPUT_VALUE：输出示值
    ...
    },
    {
        ...
        Attributes:
            [{
                ...
                //DianLiu:电流单位；DianYa:电压单位   
                //DianLiu|RANGE_UNIT:量程,OUTPUT_VALUE_UNIT:输出示值,ACTUAL_OUTPUT_VALUE_UNIT：输出实际值;DianYa|READ_VALUE_UNIT:读数值',
                DanWeiHtmlDDL: 'DianYa|READVALUE,ACTUALVALUE,SHIJISHUCHUZHI,UNCERTAINTYDEGREE;HZMY|HZMY;',
                //READ_VALUE:读数值,ACTUAL_OUTPUT_VALUE:输出实际值,RELATIVE_ERROR:相对误差,UNCERTAINTY_DEGREE:不确定度,REMARK:注,CONCLUSION:结论
                BuBaoCunShuJu: '',
                //添加量程自动计算赋值列,检测项属性单位名称1,检测项属性单位名称2,
                //OUTPUT_VALUE：输出示值
    ...
    },
    {
        ...
        Attributes:
            [{
                ...
                //DianLiu:电流单位；DianYa:电压单位   
                //DianLiu|RANGE_UNIT:量程,OUTPUT_VALUE_UNIT:输出示值,ACTUAL_OUTPUT_VALUE_UNIT：输出实际值;DianYa|READ_VALUE_UNIT:读数值',
                DanWeiHtmlDDL: 'DianLiu|READVALUE,ACTUALVALUE,SHIJISHUCHUZHI,UNCERTAINTYDEGREE;HZMY|HZMY;',
                //READ_VALUE:读数值,ACTUAL_OUTPUT_VALUE:输出实际值,RELATIVE_ERROR:相对误差,UNCERTAINTY_DEGREE:不确定度,REMARK:注,CONCLUSION:结论
                BuBaoCunShuJu: '',
                //添加量程自动计算赋值列,检测项属性单位名称1,检测项属性单位名称2,
                //OUTPUT_VALUE：输出示值
    ...
    },
    {
        ...
        Attributes:
            [{
                ...
                //DianLiu:电流单位；DianYa:电压单位   
                //DianLiu|RANGE_UNIT:量程,OUTPUT_VALUE_UNIT:输出示值,ACTUAL_OUTPUT_VALUE_UNIT：输出实际值;DianYa|READ_VALUE_UNIT:读数值',
                DanWeiHtmlDDL: 'DianYa|READVALUE,ACTUALVALUE,SHIJISHUCHUZHI,RELATIVEERROR,UNCERTAINTYDEGREE;HZMY|HZMY;',
                //READ_VALUE:读数值,ACTUAL_OUTPUT_VALUE:输出实际值,RELATIVE_ERROR:相对误差,UNCERTAINTY_DEGREE:不确定度,REMARK:注,CONCLUSION:结论
                BuBaoCunShuJu: '',
                //添加量程自动计算赋值列,检测项属性单位名称1,检测项属性单位名称2,
                //OUTPUT_VALUE：输出示值
    ...
    },
    {
        ...
        Attributes:
            [{
                ...
                //DianLiu:电流单位；DianYa:电压单位   
                //DianLiu|RANGE_UNIT:量程,OUTPUT_VALUE_UNIT:输出示值,ACTUAL_OUTPUT_VALUE_UNIT：输出实际值;DianYa|READ_VALUE_UNIT:读数值',
                DanWeiHtmlDDL: 'DianLiu|READVALUE,ACTUALVALUE,SHIJISHUCHUZHI,RELATIVEERROR,UNCERTAINTYDEGREE;HZMY|HZMY;',
                //READ_VALUE:读数值,ACTUAL_OUTPUT_VALUE:输出实际值,RELATIVE_ERROR:相对误差,UNCERTAINTY_DEGREE:不确定度,REMARK:注,CONCLUSION:结论
                BuBaoCunShuJu: '',
                //添加量程自动计算赋值列,检测项属性单位名称1,检测项属性单位名称2,
                //OUTPUT_VALUE：输出示值
                   ...
                   ,
    {
        ...
        Attributes:
            [{
                ...
                //检测项单位联动下拉框联动:变更项名称1|联动相名称1,联动相名称2;变更项名称2|联动相名称1,联动相名称2
                //一个量程下的单位与对应的输出示值和输出实际值的单位联动，更改量程的单位输出示值和输出实际值单位自动变更
                LianDongDanWeiDDL: 'bhzkhz|READVALUE,ACTUALVALUE;',
                //检测项属性单位下拉框选项单位类型1|检测项属性单位名称1,检测项属性单位名称2;单位类型2|检测项属性单位名称1,检测项属性单位名称2
                //DianLiu:电流单位；DianYa:电压单位   
                //DianLiu|RANGE_UNIT:量程,OUTPUT_VALUE_UNIT:输出示值,ACTUAL_OUTPUT_VALUE_UNIT：输出实际值;DianYa|READ_VALUE_UNIT:读数值',
      ...
      {
          RuleID: '1052-2009_2_2',//检测项编号
          Remark: '电阻示值误差-相对误差-通道',//检测项说明
          Attributes:
              [{
                  //添加通道按钮是否显示show:显示，hidden:不显示
                  DuoTongDao: 'show',
     ...
     ,
    {
       ...
       ,
    {
        RuleID: '984-2004_2',//检测项编号
        Remark: '电阻示值误差-相对误差-非通道',//检测项说明
        Attributes:
            [{
                //添加通道按钮是否显示show:显示，hidden:不显示
                DuoTongDao: 'show',
         ...
         ,
    {
        RuleID: '837-2003_2',//检测项编号
        Remark: '示值-相对误差-有允许限值-非通道',//检测项说明
        Attributes:
            [{
                //添加通道按钮是否显示show:显示，hidden:不显示
                DuoTongDao: 'show',
    ...
    },
    {
        ...
        Attributes:
            [{
                ...
                //检测项单位联动下拉框联动:变更项名称1|联动相名称1,联动相名称2;变更项名称2|联动相名称1,联动相名称2
                //一个量程下的单位与对应的输出示值和输出实际值的单位联动，更改量程的单位输出示值和输出实际值单位自动变更
                LianDongDanWeiDDL: 'RANGE|OUTPUTVALUE,READVALUE,UNCERTAINTYDEGREE;',
                //检测项属性单位下拉框选项单位类型1|检测项属性单位名称1,检测项属性单位名称2;单位类型2|检测项属性单位名称1,检测项属性单位名称2
                //DianLiu:电流单位；DianYa:电压单位   
                //DianLiu|RANGE_UNIT:量程,OUTPUT_VALUE_UNIT:输出示值,ACTUAL_OUTPUT_VALUE_UNIT：输出实际值;DianYa|READ_VALUE_UNIT:读数值',
                DanWeiHtmlDDL: 'DianYa|RANGE,OUTPUTVALUE,READVALUE,UNCERTAINTYDEGREE;',
                //READ_VALUE:读数值,ACTUAL_OUTPUT_VALUE:输出实际值,RELATIVE_ERROR:相对误差,UNCERTAINTY_DEGREE:不确定度,REMARK:注,CONCLUSION:结论
                BuBaoCunShuJu: '',
                //添加量程自动计算赋值列,检测项属性单位名称1,检测项属性单位名称2,
                //OUTPUT_VALUE：输出示值
    ...
    ,
    {
        ...
        Attributes:
            [{
                ...
                //DianLiu:电流单位；DianYa:电压单位   
                //DianLiu|RANGE_UNIT:量程,OUTPUT_VALUE_UNIT:输出示值,ACTUAL_OUTPUT_VALUE_UNIT：输出实际值;DianYa|READ_VALUE_UNIT:读数值',
                DanWeiHtmlDDL: 'DYDLW|RANGE,ACTUALVALUE,SHIJISHUCHUZHI,RELATIVEERROR',
                //READ_VALUE:读数值,ACTUAL_OUTPUT_VALUE:输出实际值,RELATIVE_ERROR:相对误差,UNCERTAINTY_DEGREE:不确定度,REMARK:注,CONCLUSION:结论
                BuBaoCunShuJu: '',
                //添加量程自动计算赋值列,检测项属性单位名称1,检测项属性单位名称2,
                //OUTPUT_VALUE：输出示值
    ...
    },
    {
        ...
        Attributes:
            [{
                ...
                //DianLiu:电流单位；DianYa:电压单位   
                //DianLiu|RANGE_UNIT:量程,OUTPUT_VALUE_UNIT:输出示值,ACTUAL_OUTPUT_VALUE_UNIT：输出实际值;DianYa|READ_VALUE_UNIT:读数值',
                DanWeiHtmlDDL: 'DianYa|RANGE1;DianLiu|RANGE',
                //READ_VALUE:读数值,ACTUAL_OUTPUT_VALUE:输出实际值,RELATIVE_ERROR:相对误差,UNCERTAINTY_DEGREE:不确定度,REMARK:注,CONCLUSION:结论
                BuBaoCunShuJu: '',
                //添加量程自动计算赋值列,检测项属性单位名称1,检测项属性单位名称2,
                //OUTPUT_VALUE：输出示值
    ...
    ,
    {
        ...
        Attributes:
            [{
                ...
                //DianLiu:电流单位；DianYa:电压单位   
                //DianLiu|RANGE_UNIT:量程,OUTPUT_VALUE_UNIT:输出示值,ACTUAL_OUTPUT_VALUE_UNIT：输出实际值;DianYa|READ_VALUE_UNIT:读数值',
                DanWeiHtmlDDL: 'ZhiHouChaoQian|READVALUE;DianYa|RANGE1;DianLiu|RANGE',
                //READ_VALUE:读数值,ACTUAL_OUTPUT_VALUE:输出实际值,RELATIVE_ERROR:相对误差,UNCERTAINTY_DEGREE:不确定度,REMARK:注,CONCLUSION:结论
                BuBaoCunShuJu: '',
                //添加量程自动计算赋值列,检测项属性单位名称1,检测项属性单位名称2,
                //OUTPUT_VALUE：输出示值
      ...
      ,
    {
        ...
        Attributes:
            [{
                ...
                //DianLiu:电流单位；DianYa:电压单位   
                //DianLiu|RANGE_UNIT:量程,OUTPUT_VALUE_UNIT:输出示值,ACTUAL_OUTPUT_VALUE_UNIT：输出实际值;DianYa|READ_VALUE_UNIT:读数值',
                DanWeiHtmlDDL: 'DianYa|RANGE;OM|OUTPUTVALUE,ACTUALVALUE,SHIJISHUCHUZHI',//EDingDianYa
                //READ_VALUE:读数值,ACTUAL_OUTPUT_VALUE:输出实际值,RELATIVE_ERROR:相对误差,UNCERTAINTY_DEGREE:不确定度,REMARK:注,CONCLUSION:结论
                BuBaoCunShuJu: '',
                //添加量程自动计算赋值列,检测项属性单位名称1,检测项属性单位名称2,
                //OUTPUT_VALUE：输出示值
