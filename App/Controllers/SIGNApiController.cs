...
namespace Langben.App.Controllers
{
    ...
    /// 委托单签字
    /// </summary>
    public class SIGNApiController : BaseApiController
    {
        /// <summary>
        /// 异步加载数据
        /// </summary>
        ...
        /// <returns></returns>  
        public Common.ClientResult.Result Put([FromBody]SIGN entity)
        {
            Common.ClientResult.Result result = new Common.ClientResult.Result();
            if (entity != null && ModelState.IsValid)
            {   //数据校验
                ...
                {
                    LogClassModels.WriteServiceLog(Suggestion.UpdateSucceed + "，委托单签字信息的Id为" + entity.ID,"委托单签字"
                        );//写入日志                   
                    result.Code = Common.ClientCode.Succeed;
                ...
                else
                {
                    ...
                    LogClassModels.WriteServiceLog(Suggestion.UpdateFail + "，委托单签字信息的Id为" + entity.ID + "," + returnValue, "委托单签字"
                        );//写入日志   
                    result.Code = Common.ClientCode.Fail;
        ...
        public SIGNApiController()
            : this(new SIGNBLL()) { }

        public SIGNApiController(SIGNBLL bll)
        {
            m_BLL = bll;
        }
    }
