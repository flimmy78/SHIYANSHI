...
namespace Langben.App.Controllers
{
    ...
    /// 合格不合格检定项目
    /// </summary>
    public class QUALIFIED_UNQUALIFIED_TEST_ITEApiController : BaseApiController
    {
        /// <summary>
        /// 异步加载数据
        /// </summary>
        ...
        {
            int total = 0;
            List<QUALIFIED_UNQUALIFIED_TEST_ITE> queryData = m_BLL.GetByParam(null, getParam.page, getParam.rows, getParam.order, getParam.sort, getParam.search, ref total);
        ...
        public QUALIFIED_UNQUALIFIED_TEST_ITEApiController()
            : this(new QUALIFIED_UNQUALIFIED_TEST_ITEBLL()) { }

        public QUALIFIED_UNQUALIFIED_TEST_ITEApiController(QUALIFIED_UNQUALIFIED_TEST_ITEBLL bll)
        {
            m_BLL = bll;
        }
