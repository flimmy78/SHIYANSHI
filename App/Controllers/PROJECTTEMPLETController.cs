...
namespace Langben.App.Controllers
{
    ...
    {//
     ...
     /// <returns></returns>
        public ActionResult BuPingHengFuZaiShiYouGongDianNengWuCha(string RULEID = "126-1995_2_6_1", string SCHEMEID = "", string PREPARE_SCHEMEID = "")
        {
        ...
        /// <param name="PREPARE_SCHEMEID">预备方案id</param>
        /// <returns></returns>
        public ActionResult BianBiShiZhi(string RULEID = "126-1995_2_6_1", string SCHEMEID = "", string PREPARE_SCHEMEID = "")
        {
        ...
        /// <param name="PREPARE_SCHEMEID">预备方案id</param>
        /// <returns></returns>
        public ActionResult ShiZhiWuCha(string RULEID = "126-1995_2_6_1", string SCHEMEID = "", string PREPARE_SCHEMEID = "")
        {
        ...
        /// <param name="PREPARE_SCHEMEID">预备方案id</param>
        /// <returns></returns>
        public ActionResult JiBenWuChaJianDing(string RULEID = "126-1995_2_6_1", string SCHEMEID = "", string PREPARE_SCHEMEID = "")
        {
        ...
        /// <param name="PREPARE_SCHEMEID">预备方案id</param>
        /// <returns></returns>
        public ActionResult FeiEDingFUZaiYngXiang(string RULEID = "126-1995_2_6_1", string SCHEMEID = "", string PREPARE_SCHEMEID = "")
        {
        ...
        /// <param name="PREPARE_SCHEMEID">预备方案id</param>
        /// <returns></returns>
        public ActionResult PianLiLingWei(string RULEID = "126-1995_2_6_1", string SCHEMEID = "", string PREPARE_SCHEMEID = "")
        {
        ...
        /// <param name="PREPARE_SCHEMEID">预备方案id</param>
        /// <returns></returns>
        public ActionResult CeLiangWuCha(string RULEID = "126-1995_2_6_1", string SCHEMEID = "", string PREPARE_SCHEMEID = "")
        {
        ...
        /// <param name="PREPARE_SCHEMEID">预备方案id</param>
        /// <returns></returns>
        public ActionResult JiBenWuChaHeShengJiangBianCha440(string RULEID = "126-1995_2_6_1", string SCHEMEID = "", string PREPARE_SCHEMEID = "")
        {
        ...
        /// <param name="PREPARE_SCHEMEID">预备方案id</param>
        /// <returns></returns>
        public ActionResult JiBenWuChaHeShengJiangBianCha(string RULEID = "126-1995_2_6_1", string SCHEMEID = "", string PREPARE_SCHEMEID = "")
        {
