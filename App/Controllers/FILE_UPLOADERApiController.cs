...
namespace Langben.App.Controllers
{
    ...
    /// 附件
    /// </summary>
    public class FILE_UPLOADERApiController : BaseApiController
    {
        /// <summary>
        /// 异步加载数据
        /// </summary>
        ...
        IBLL.IFILE_UPLOADERBLL m_BLL;

        ValidationErrors validationErrors = new ValidationErrors();

        public FILE_UPLOADERApiController()
            : this(new FILE_UPLOADERBLL()) { }

        public FILE_UPLOADERApiController(FILE_UPLOADERBLL bll)
        {
            m_BLL = bll;
        }
