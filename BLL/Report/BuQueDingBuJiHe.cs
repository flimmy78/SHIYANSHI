...
namespace Langben.BLL.Report
{
    ...
    public static partial class BuQueDingBuJiHe
    {
        ...
        static BuQueDingBuJiHe()
        {
            ...
            jihe.Add(new BuQueDingDu() { RuleID = "d1587-2016_2_1", GongShi = "2", MingChen = "5720A直流电压测量", DianZu = "N", ShuChu = "N" });
            ...
            jihe.Add(new BuQueDingDu() { RuleID = "d1587-2016_3_1", GongShi = "2", MingChen = "5720A直流电流测量", DianZu = "N", ShuChu = "N" });

            jihe.Add(new BuQueDingDu() { RuleID = "315-1983_2_5", GongShi = "2", MingChen = "5720A直流电压测量", DianZu = "N", ShuChu = "N" });
            jihe.Add(new BuQueDingDu() { RuleID = "d1587-2016_2_2", GongShi = "2", MingChen = "5720A直流电压测量", DianZu = "N", ShuChu = "N" });
            jihe.Add(new BuQueDingDu() { RuleID = "598-1989_2_6", GongShi = "2", MingChen = "5720A直流电流测量", DianZu = "N", ShuChu = "N" });
            jihe.Add(new BuQueDingDu() { RuleID = "d1587-2016_3_2", GongShi = "2", MingChen = "5720A直流电流测量", DianZu = "N", ShuChu = "N" });
            jihe.Add(new BuQueDingDu() { RuleID = "315-1983_2_2", GongShi = "2", MingChen = "5720A直流电压测量", DianZu = "N", ShuChu = "N" });
            jihe.Add(new BuQueDingDu() { RuleID = "1587-2016_2_1", GongShi = "2", MingChen = "5720A直流电压测量", DianZu = "N", ShuChu = "N" });
            ...
            jihe.Add(new BuQueDingDu() { RuleID = "d1587-2016_4_1", GongShi = "5", MingChen = "5720A直流电阻测量", DianZu = "N", ShuChu = "N" });
            jihe.Add(new BuQueDingDu() { RuleID = "724-1991_2_2", GongShi = "5", MingChen = "5720A直流电阻测量", DianZu = "N", ShuChu = "N" });
            jihe.Add(new BuQueDingDu() { RuleID = "d1587-2016_4_2", GongShi = "5", MingChen = "5720A直流电阻测量", DianZu = "N", ShuChu = "N" });
            ...
            jihe.Add(new BuQueDingDu() { RuleID = "1587-2016_5_1", GongShi = "2", MingChen = "5720A交流电压测量三相", DianZu = "N", ShuChu = "N" });
            jihe.Add(new BuQueDingDu() { RuleID = "d34-1999_3_2", GongShi = "2", MingChen = "5720A交流电压测量单相", DianZu = "N", ShuChu = "N" });
            jihe.Add(new BuQueDingDu() { RuleID = "d1587-2016_5_1", GongShi = "2", MingChen = "5720A交流电压测量单相", DianZu = "N", ShuChu = "N" });

            jihe.Add(new BuQueDingDu() { RuleID = "35-1999_3_2", GongShi = "2", MingChen = "5720A交流电流测量", DianZu = "N", ShuChu = "N" });
            jihe.Add(new BuQueDingDu() { RuleID = "1587-2016_6_1", GongShi = "2", MingChen = "5720A交流电流测量", DianZu = "N", ShuChu = "N" });
            jihe.Add(new BuQueDingDu() { RuleID = "d35-1999_3_2", GongShi = "2", MingChen = "5720A交流电流测量", DianZu = "N", ShuChu = "N" });
            jihe.Add(new BuQueDingDu() { RuleID = "d1587-2016_6_1", GongShi = "2", MingChen = "5720A交流电流测量", DianZu = "N", ShuChu = "N" });

            jihe.Add(new BuQueDingDu() { RuleID = "34-1999_3_7", GongShi = "2", MingChen = "5720A交流电压测量单相", DianZu = "N", ShuChu = "N" });
            jihe.Add(new BuQueDingDu() { RuleID = "d1587-2016_5_2", GongShi = "2", MingChen = "5720A交流电压测量单相", DianZu = "N", ShuChu = "N" });
            jihe.Add(new BuQueDingDu() { RuleID = "35-1999_3_7", GongShi = "2", MingChen = "5720A交流电流测量", DianZu = "N", ShuChu = "N" });
            jihe.Add(new BuQueDingDu() { RuleID = "d1587-2016_6_2", GongShi = "2", MingChen = "5720A交流电流测量", DianZu = "N", ShuChu = "N" });
            ...
            jihe.Add(new BuQueDingDu() { RuleID = "1112-2015_20", GongShi = "9", MingChen = "8508A直流电流输出", DianZu = "N", ShuChu = "Y" });
            jihe.Add(new BuQueDingDu() { RuleID = "1112-2015_22", GongShi = "9", MingChen = "8508A直流电流输出", DianZu = "N", ShuChu = "Y" });
            jihe.Add(new BuQueDingDu() { RuleID = "1112-2015_20", GongShi = "8", MingChen = "8508A直流电压输出", DianZu = "Y", ShuChu = "Y" });
            jihe.Add(new BuQueDingDu() { RuleID = "1112-2015_22", GongShi = "8", MingChen = "8508A直流电压输出", DianZu = "Y", ShuChu = "Y" });
