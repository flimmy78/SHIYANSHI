...
namespace Langben.DAL
{
    ...
    /// 方案
    /// </summary>
    public partial class SCHEMERepository : BaseRepository<SCHEME>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<SCHEME> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<SCHEME>().Where(string.IsNullOrEmpty(where) ? "true" : where)
        ...
        /// <param name="id">一条方案的主键</param>
        public void Delete(SysEntities db, string id)
        {
            SCHEME deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.SCHEME.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<SCHEME> collection = from f in db.SCHEME
