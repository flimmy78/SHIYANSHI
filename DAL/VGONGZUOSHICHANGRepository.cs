...
namespace Langben.DAL
{
    ...
    /// 工作时长查询
    /// </summary>
    public class VGONGZUOSHICHANGRepository : BaseRepository<VGONGZUOSHICHANG>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<VGONGZUOSHICHANG> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            var data= ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<VGONGZUOSHICHANG>().Where(string.IsNullOrEmpty(where) ? "true" : where)
