...
namespace Langben.DAL
{
    ...
    /// 检定项目模板
    /// </summary>
    public partial class PROJECTTEMPLETRepository : BaseRepository<PROJECTTEMPLET>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<PROJECTTEMPLET> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<PROJECTTEMPLET>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取检定项目模板---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>检定项目模板</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>检定项目模板</returns>
        public PROJECTTEMPLET GetById(SysEntities db, string id)
        { 
            return db.PROJECTTEMPLET.SingleOrDefault(s => s.ID == id);
        ...
        /// <param name="id">一条检定项目模板的主键</param>
        public void Delete(SysEntities db, string id)
        {
            PROJECTTEMPLET deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.PROJECTTEMPLET.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<PROJECTTEMPLET> collection = from f in db.PROJECTTEMPLET
