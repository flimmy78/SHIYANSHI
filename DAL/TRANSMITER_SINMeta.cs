...
{
    [MetadataType(typeof(TRANSMITER_SINMetadata))]//使用TRANSMITER_SINMetadata对TRANSMITER_SIN进行数据验证
    ...
    public partial class TRANSMITER_SINMetadata
    {
			...
			[ScaffoldColumn(true)]
			[Display(Name = "sinφ", Order = 6)]
			public object SIN { get; set; }

			[ScaffoldColumn(true)]
			[Display(Name = "sinφ单位", Order = 7)]
			public object SIN_UNIT { get; set; }

			[ScaffoldColumn(true)]
			[Display(Name = "二次输入标准值", Order = 8)]
			public object TWO_INPUT_STANDARD_VALUE { get; set; }

			[ScaffoldColumn(true)]
			[Display(Name = "二次输入标准值单位", Order = 9)]
			public object TWO_INPUT_STANDARD_VALUE_UNIT { get; set; }
