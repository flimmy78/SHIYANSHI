...
namespace Langben.DAL
{
    ...
    /// 表头坐标数据
    /// </summary>
    public partial class TABLE_HEAD_XYRepository : BaseRepository<TABLE_HEAD_XY>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<TABLE_HEAD_XY> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<TABLE_HEAD_XY>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取表头坐标数据---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>表头坐标数据</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>表头坐标数据</returns>
        public TABLE_HEAD_XY GetById(SysEntities db, string id)
        { 
            return db.TABLE_HEAD_XY.SingleOrDefault(s => s.ID == id);
        ...
        /// <param name="id">一条表头坐标数据的主键</param>
        public void Delete(SysEntities db, string id)
        {
            TABLE_HEAD_XY deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.TABLE_HEAD_XY.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<TABLE_HEAD_XY> collection = from f in db.TABLE_HEAD_XY
        ...
        /// <summary>
        /// 根据TEST_ITEM_FORMATID，获取所有表头坐标数据数据
        /// </summary>
        /// <param name="id">外键的主键</param>
        /// <returns></returns>
        public IQueryable<TABLE_HEAD_XY> GetByRefTEST_ITEM_FORMATID(SysEntities db, string id)
        {
            return from c in db.TABLE_HEAD_XY
