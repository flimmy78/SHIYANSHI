...
namespace Langben.DAL
{
    ...
    /// 频率表
    /// </summary>
    public partial class FREQUENCYRepository : BaseRepository<FREQUENCY>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<FREQUENCY> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<FREQUENCY>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取频率表---查看详细，首次编辑
        /// </summary>
        ...
        /// <param name="id">主键</param>
        /// <returns>频率表</returns>
        public FREQUENCY GetById(SysEntities db, string id)
        { 
            return db.FREQUENCY.SingleOrDefault(s => s.ID == id);
        ...
        /// <param name="id">一条频率表的主键</param>
        public void Delete(SysEntities db, string id)
        {
            FREQUENCY deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.FREQUENCY.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<FREQUENCY> collection = from f in db.FREQUENCY
        ...
        /// <summary>
        /// 根据OVERALL_TABLEID，获取所有频率表数据
        /// </summary>
        /// <param name="id">外键的主键</param>
        /// <returns></returns>
        public IQueryable<FREQUENCY> GetByRefOVERALL_TABLEID(SysEntities db, string id)
        {
            return from c in db.FREQUENCY
