...
namespace Langben.DAL
{
    ...
    /// 不确定度参数管理
    /// </summary>
    public partial class UNCERTAINTYPARAMETERMANAGEMENTRepository : BaseRepository<UNCERTAINTYPARAMETERMANAGEMENT>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<UNCERTAINTYPARAMETERMANAGEMENT> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<UNCERTAINTYPARAMETERMANAGEMENT>().Where(string.IsNullOrEmpty(where) ? "true" : where)
        ...
        /// <param name="id">一条不确定度参数管理的主键</param>
        public void Delete(SysEntities db, string id)
        {
            UNCERTAINTYPARAMETERMANAGEMENT deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.UNCERTAINTYPARAMETERMANAGEMENT.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<UNCERTAINTYPARAMETERMANAGEMENT> collection = from f in db.UNCERTAINTYPARAMETERMANAGEMENT
