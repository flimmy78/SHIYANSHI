...
{
    [MetadataType(typeof(DC_VOLTAGE_CURRENT_MEASURE_CHMetadata))]//使用DC_VOLTAGE_CURRENT_MEASURE_CHMetadata对DC_VOLTAGE_CURRENT_MEASURE_CH进行数据验证
    public partial class DC_VOLTAGE_CURRENT_MEASURE_CH 
    {
    ...
    public partial class DC_VOLTAGE_CURRENT_MEASURE_CHMetadata
    {
