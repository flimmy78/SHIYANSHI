...
namespace Langben.DAL
{
    ...
    /// 报告打印
    /// </summary>
    public class VBAOGAODAYINRepository : BaseRepository<VBAOGAODAYIN>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<VBAOGAODAYIN> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
        ...
        /// <summary>
        /// 通过主键id，获取报告打印---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>报告打印</returns>
        public VBAOGAODAYIN GetById(string id)
        {
        ...
        /// <param name="id">主键</param>
        /// <returns>报告打印</returns>
        public VBAOGAODAYIN GetById(SysEntities db, string id)
        { 
                 return db.VBAOGAODAYIN.SingleOrDefault(s => s.ID == id); 
        }
