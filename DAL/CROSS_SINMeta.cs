...
{
    [MetadataType(typeof(CROSS_SINMetadata))]//使用CROSS_SINMetadata对CROSS_SIN进行数据验证
    public partial class CROSS_SIN 
    {
    ...
    public partial class CROSS_SINMetadata
    {
			...
			[ScaffoldColumn(true)]
			[Display(Name = "交采头", Order = 10)]
			public object CROSS_HEADID { get; set; }

			[ScaffoldColumn(true)]
			[Display(Name = "预备方案", Order = 11)]
