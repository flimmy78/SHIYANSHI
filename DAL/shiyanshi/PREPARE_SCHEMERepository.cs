    ...
    public partial class PREPARE_SCHEMERepository : BaseRepository<PREPARE_SCHEME>, IDisposable
    {
        ...
        public void EditField(SysEntities db, PREPARE_SCHEME entity)
        {
            ...
            foreach (var deleteItem in collection)
            {
                ...
                deleteItem.OTHER = entity.OTHER == null ? deleteItem.OTHER : entity.OTHER;
            }
        }
        ...
        /// <param name="db">实体数据</param>
        /// <param name="entity">表的实体类</param>
        public PREPARE_SCHEME EditInst(SysEntities db, PREPARE_SCHEME entity)
        {
            //数据库设置级联关系，自动删除子表的内容   
            PREPARE_SCHEME deleteItem = (from f in db.PREPARE_SCHEME
                                         where f.ID == entity.ID
