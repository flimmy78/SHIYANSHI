...
{
    public class VRULERepository : BaseRepository<VRULE>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<VRULE> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext
                     .CreateObjectSet<VRULE>().Where(string.IsNullOrEmpty(where) ? "true" : where)
        ...
        public VRULE GetById(SysEntities db, string RULEID)
        {
            return db.VRULE.SingleOrDefault(s => s.ID == RULEID);
        }
