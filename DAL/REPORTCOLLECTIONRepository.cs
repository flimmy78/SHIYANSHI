...
namespace Langben.DAL
{
    ...
    /// 报告领取
    /// </summary>
    public partial class REPORTCOLLECTIONRepository : BaseRepository<REPORTCOLLECTION>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<REPORTCOLLECTION> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<REPORTCOLLECTION>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取报告领取---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>报告领取</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>报告领取</returns>
        public REPORTCOLLECTION GetById(SysEntities db, string id)
        { 
            return db.REPORTCOLLECTION.SingleOrDefault(s => s.ID == id);
        ...
        /// <param name="id">一条报告领取的主键</param>
        public void Delete(SysEntities db, string id)
        {
            REPORTCOLLECTION deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.REPORTCOLLECTION.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<REPORTCOLLECTION> collection = from f in db.REPORTCOLLECTION
        ...
        /// <summary>
        /// 根据PREPARE_SCHEMEID，获取所有报告领取数据
        /// </summary>
        /// <param name="id">外键的主键</param>
        /// <returns></returns>
        public IQueryable<REPORTCOLLECTION> GetByRefPREPARE_SCHEMEID(SysEntities db, string id)
        {
            return from c in db.REPORTCOLLECTION
