...
namespace Langben.DAL
{
    ...
    public partial class ALLOWABLE_ERRORRepository : BaseRepository<ALLOWABLE_ERROR>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<ALLOWABLE_ERROR> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<ALLOWABLE_ERROR>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取最大允许误差信息---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>最大允许误差信息</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>最大允许误差信息</returns>
        public ALLOWABLE_ERROR GetById(SysEntities db, string id)
        { 
            return db.ALLOWABLE_ERROR.SingleOrDefault(s => s.ID == id);
        ...
        /// <param name="id">一条最大允许误差信息的主键</param>
        public void Delete(SysEntities db, string id)
        {
            ALLOWABLE_ERROR deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.ALLOWABLE_ERROR.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        /// <summary>
        /// 根据METERING_STANDARD_DEVICEID，获取所有最大允许误差信息数据
        /// </summary>
        /// <param name="id">外键的主键</param>
        /// <returns></returns>
        public IQueryable<ALLOWABLE_ERROR> GetByRefMETERING_STANDARD_DEVICEID(SysEntities db, string id)
        {
            return from c in db.ALLOWABLE_ERROR
