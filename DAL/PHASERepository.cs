...
namespace Langben.DAL
{
    ...
    /// 相位
    /// </summary>
    public partial class PHASERepository : BaseRepository<PHASE>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<PHASE> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<PHASE>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取相位---查看详细，首次编辑
        /// </summary>
        ...
        /// <param name="id">主键</param>
        /// <returns>相位</returns>
        public PHASE GetById(SysEntities db, string id)
        { 
            return db.PHASE.SingleOrDefault(s => s.ID == id);
        ...
        /// <param name="id">一条相位的主键</param>
        public void Delete(SysEntities db, string id)
        {
            PHASE deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.PHASE.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<PHASE> collection = from f in db.PHASE
        ...
        /// <summary>
        /// 根据OVERALL_TABLEID，获取所有相位数据
        /// </summary>
        /// <param name="id">外键的主键</param>
        /// <returns></returns>
        public IQueryable<PHASE> GetByRefOVERALL_TABLEID(SysEntities db, string id)
        {
            return from c in db.PHASE
