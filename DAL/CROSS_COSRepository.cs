...
namespace Langben.DAL
{
    ...
    /// 交采cos
    /// </summary>
    public partial class CROSS_COSRepository : BaseRepository<CROSS_COS>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<CROSS_COS> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<CROSS_COS>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取交采cos---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>交采cos</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>交采cos</returns>
        public CROSS_COS GetById(SysEntities db, string id)
        { 
            return db.CROSS_COS.SingleOrDefault(s => s.ID == id);
        ...
        /// <param name="id">一条交采cos的主键</param>
        public void Delete(SysEntities db, string id)
        {
            CROSS_COS deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.CROSS_COS.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<CROSS_COS> collection = from f in db.CROSS_COS
        ...
        /// <summary>
        /// 根据CROSS_HEADID，获取所有交采cos数据
        /// </summary>
        /// <param name="id">外键的主键</param>
        /// <returns></returns>
        public IQueryable<CROSS_COS> GetByRefCROSS_HEADID(SysEntities db, string id)
        {
            return from c in db.CROSS_COS
