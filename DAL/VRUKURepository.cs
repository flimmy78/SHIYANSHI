...
namespace Langben.DAL
{
    ...
    /// 入库
    /// </summary>
    public class VRUKURepository : BaseRepository<VRUKU>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<VRUKU> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
        ...
        /// <param name="id">主键</param>
        /// <returns>入库</returns>
        public VRUKU GetById(SysEntities db,string  id)
        { 
                 return db.VRUKU.SingleOrDefault(s => s.ID == id); 
        }
