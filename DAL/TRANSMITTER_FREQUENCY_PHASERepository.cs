...
namespace Langben.DAL
{
    ...
    /// 变送器频率相位
    /// </summary>
    public partial class TRANSMITTER_FREQUENCY_PHASERepository : BaseRepository<TRANSMITTER_FREQUENCY_PHASE>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<TRANSMITTER_FREQUENCY_PHASE> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<TRANSMITTER_FREQUENCY_PHASE>().Where(string.IsNullOrEmpty(where) ? "true" : where)
        ...
        /// <param name="id">一条变送器频率相位的主键</param>
        public void Delete(SysEntities db, string id)
        {
            TRANSMITTER_FREQUENCY_PHASE deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.TRANSMITTER_FREQUENCY_PHASE.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<TRANSMITTER_FREQUENCY_PHASE> collection = from f in db.TRANSMITTER_FREQUENCY_PHASE
