...
namespace Langben.DAL
{
    ...
    public partial class RULERepository : BaseRepository<RULE>, IDisposable
    {
        ...
        /// <summary>
        /// 根据UNDERTAKE_LABORATORYID，获取所有规程表数据
        /// </summary>
        /// <param name="id">外键的主键</param>
        /// <returns></returns>
        public IQueryable<RULE> GetByRefUNDERTAKE_LABORATORYID(SysEntities db, string id)
        {
            return from c in db.RULE
