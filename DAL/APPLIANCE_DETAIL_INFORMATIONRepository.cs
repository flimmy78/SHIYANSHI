...
namespace Langben.DAL
{
    ...
    /// 器具明细信息
    /// </summary>
    public partial class APPLIANCE_DETAIL_INFORMATIONRepository : BaseRepository<APPLIANCE_DETAIL_INFORMATION>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<APPLIANCE_DETAIL_INFORMATION> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
        ...
        /// <summary>
        /// 通过主键id，获取器具明细信息---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>器具明细信息</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>器具明细信息</returns>
        public APPLIANCE_DETAIL_INFORMATION GetById(SysEntities db, string id)
        { 
            return db.APPLIANCE_DETAIL_INFORMATION.SingleOrDefault(s => s.ID == id);
        ...
        /// <param name="id">一条器具明细信息的主键</param>
        public void Delete(SysEntities db, string id)
        {
            APPLIANCE_DETAIL_INFORMATION deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.APPLIANCE_DETAIL_INFORMATION.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
