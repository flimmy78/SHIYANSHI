...
namespace Langben.DAL
{
    ...
    /// 方案_规程
    /// </summary>
    public partial class SCHEME_RULERepository : BaseRepository<SCHEME_RULE>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<SCHEME_RULE> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<SCHEME_RULE>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取方案_规程---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>方案_规程</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>方案_规程</returns>
        public SCHEME_RULE GetById(SysEntities db, string id)
        { 
            return db.SCHEME_RULE.SingleOrDefault(s => s.ID == id);
        ...
        /// <param name="id">一条方案_规程的主键</param>
        public void Delete(SysEntities db, string id)
        {
            SCHEME_RULE deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.SCHEME_RULE.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<SCHEME_RULE> collection = from f in db.SCHEME_RULE
        ...
        /// <summary>
        /// 根据RULEID，获取所有方案_规程数据
        /// </summary>
        /// <param name="id">外键的主键</param>
        /// <returns></returns>
        public IQueryable<SCHEME_RULE> GetByRefRULEID(SysEntities db, string id)
        {
        ...
        /// <summary>
        /// 根据SCHEMEID，获取所有方案_规程数据
        /// </summary>
        /// <param name="id">外键的主键</param>
        /// <returns></returns>
        public IQueryable<SCHEME_RULE> GetByRefSCHEMEID(SysEntities db, string id)
        {
            return from c in db.SCHEME_RULE
                        where c.SCHEMEID == id
                        select c;
