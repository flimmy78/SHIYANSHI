...
namespace Langben.DAL
{
    ...
    /// 器具领取2
    /// </summary>
    public class VQIJULINGQU2Repository : BaseRepository<VQIJULINGQU2>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<VQIJULINGQU2> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<VQIJULINGQU2>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取器具领取2---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>器具领取2</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>器具领取2</returns>
        public VQIJULINGQU2 GetById(SysEntities db, string id)
        { 
                 return db.VQIJULINGQU2.SingleOrDefault(s => s.ID == id); 
        }
