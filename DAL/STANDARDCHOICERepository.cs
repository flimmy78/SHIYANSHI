...
namespace Langben.DAL
{
    ...
    /// 标准器选择
    /// </summary>
    public partial class STANDARDCHOICERepository : BaseRepository<STANDARDCHOICE>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<STANDARDCHOICE> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<STANDARDCHOICE>().Where(string.IsNullOrEmpty(where) ? "true" : where)
        ...
        /// <param name="id">一条标准器选择的主键</param>
        public void Delete(SysEntities db, string id)
        {
            STANDARDCHOICE deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.STANDARDCHOICE.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<STANDARDCHOICE> collection = from f in db.STANDARDCHOICE
