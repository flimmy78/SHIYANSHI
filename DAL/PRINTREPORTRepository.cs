...
namespace Langben.DAL
{
    ...
    /// 打印报告
    /// </summary>
    public partial class PRINTREPORTRepository : BaseRepository<PRINTREPORT>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<PRINTREPORT> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<PRINTREPORT>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取打印报告---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>打印报告</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>打印报告</returns>
        public PRINTREPORT GetById(SysEntities db, string id)
        { 
            return db.PRINTREPORT.SingleOrDefault(s => s.ID == id);
        ...
        /// <param name="id">一条打印报告的主键</param>
        public void Delete(SysEntities db, string id)
        {
            PRINTREPORT deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.PRINTREPORT.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<PRINTREPORT> collection = from f in db.PRINTREPORT
        ...
        /// <summary>
        /// 根据PREPARE_SCHEMEID，获取所有打印报告数据
        /// </summary>
        /// <param name="id">外键的主键</param>
        /// <returns></returns>
        public IQueryable<PRINTREPORT> GetByRefPREPARE_SCHEMEID(SysEntities db, string id)
        {
            return from c in db.PRINTREPORT
