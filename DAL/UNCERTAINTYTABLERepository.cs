...
namespace Langben.DAL
{
    ...
    public partial class UNCERTAINTYTABLERepository : BaseRepository<UNCERTAINTYTABLE>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<UNCERTAINTYTABLE> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<UNCERTAINTYTABLE>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取不确定度---查看详细，首次编辑
        /// </summary>
        ...
        /// <param name="id">主键</param>
        /// <returns>不确定度</returns>
        public UNCERTAINTYTABLE GetById(SysEntities db, string id)
        { 
            return db.UNCERTAINTYTABLE.SingleOrDefault(s => s.ID == id);
        ...
        /// <param name="id">一条不确定度的主键</param>
        public void Delete(SysEntities db, string id)
        {
            UNCERTAINTYTABLE deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.UNCERTAINTYTABLE.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        /// <summary>
        /// 根据METERING_STANDARD_DEVICEID，获取所有不确定度数据
        /// </summary>
        /// <param name="id">外键的主键</param>
        /// <returns></returns>
        public IQueryable<UNCERTAINTYTABLE> GetByRefMETERING_STANDARD_DEVICEID(SysEntities db, string id)
        {
            return from c in db.UNCERTAINTYTABLE
