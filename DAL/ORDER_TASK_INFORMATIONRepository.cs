...
namespace Langben.DAL
{
    ...
    public partial class ORDER_TASK_INFORMATIONRepository : BaseRepository<ORDER_TASK_INFORMATION>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<ORDER_TASK_INFORMATION> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<ORDER_TASK_INFORMATION>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取委托单信息---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>委托单信息</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>委托单信息</returns>
        public ORDER_TASK_INFORMATION GetById(SysEntities db, string id)
        { 
            return db.ORDER_TASK_INFORMATION.SingleOrDefault(s => s.ID == id);
        ...
        /// <param name="id">一条委托单信息的主键</param>
        public void Delete(SysEntities db, string id)
        {
            ORDER_TASK_INFORMATION deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.ORDER_TASK_INFORMATION.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
