...
namespace Langben.DAL
{
    ...
    /// 单位
    /// </summary>
    public partial class COMPANYRepository : BaseRepository<COMPANY>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<COMPANY> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
        ...
        /// <param name="id">主键</param>
        /// <returns>单位</returns>
        public COMPANY GetById(SysEntities db, string id)
        { 
            return db.COMPANY.SingleOrDefault(s => s.ID == id);
