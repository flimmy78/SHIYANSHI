...
{
    [MetadataType(typeof(AC_VOLTAGE_CURRENTMetadata))]//使用AC_VOLTAGE_CURRENTMetadata对AC_VOLTAGE_CURRENT进行数据验证
    public partial class AC_VOLTAGE_CURRENT 
    {
    ...
    public partial class AC_VOLTAGE_CURRENTMetadata
    {
			...
			[ScaffoldColumn(true)]
			[Display(Name = "引用误差", Order = 8)]
			public object REFERENCE_ERROR { get; set; }

			[ScaffoldColumn(true)]
			[Display(Name = "引用误差单位", Order = 9)]
