...
namespace Langben.DAL
{
    ...
    public class VSHENPIRepository : BaseRepository<VSHENPI>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<VSHENPI> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
        ...
        /// <param name="id">主键</param>
        /// <returns>审批</returns>
        public VSHENPI GetById(SysEntities db, string id)
        { 
                 return db.VSHENPI.SingleOrDefault(s => s.ID == id); 
        }
